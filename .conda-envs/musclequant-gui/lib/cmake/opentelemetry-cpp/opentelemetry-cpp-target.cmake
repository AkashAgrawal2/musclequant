...
add_library(opentelemetry-cpp::proto_grpc SHARED IMPORTED)

set_target_properties(opentelemetry-cpp::proto_grpc PROPERTIES
  INTERFACE_LINK_LIBRARIES "opentelemetry-cpp::proto;gRPC::grpc++"
)
...
set_target_properties(opentelemetry-cpp::api PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "OPENTELEMETRY_DEPRECATED_SDK_FACTORY;HAVE_ABSEIL;OPENTELEMETRY_ABI_VERSION_NO=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::bad_variant_access;absl::any;absl::base;absl::bits;absl::city;-framework CoreFoundation"
)
...
add_library(opentelemetry-cpp::logs SHARED IMPORTED)
...
set_target_properties(opentelemetry-cpp::http_client_curl PROPERTIES
  INTERFACE_LINK_LIBRARIES "opentelemetry-cpp::common;opentelemetry-cpp::ext"
)
...
set_target_properties(opentelemetry-cpp::otlp_grpc_client PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "opentelemetry-cpp::sdk;opentelemetry-cpp::common;opentelemetry-cpp::ext;opentelemetry-cpp::proto_grpc"
)
...
set_target_properties(opentelemetry-cpp::otlp_http_client PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "opentelemetry-cpp::sdk;opentelemetry-cpp::ext;opentelemetry-cpp::common;absl::strings"
)
...
add_library(opentelemetry-cpp::otlp_http_log_record_exporter SHARED IMPORTED)
...
set_target_properties(opentelemetry-cpp::ostream_metrics_exporter PROPERTIES
  INTERFACE_LINK_LIBRARIES "opentelemetry-cpp::metrics;opentelemetry-cpp::resources"
)

# Create imported target opentelemetry-cpp::ostream_log_record_exporter
add_library(opentelemetry-cpp::ostream_log_record_exporter SHARED IMPORTED)
...
add_library(opentelemetry-cpp::prometheus_exporter SHARED IMPORTED)

set_target_properties(opentelemetry-cpp::prometheus_exporter PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "opentelemetry-cpp::metrics;prometheus-cpp::pull;prometheus-cpp::core;prometheus-cpp::util"
)

# Create imported target opentelemetry-cpp::opentelemetry_exporter_zipkin_trace
add_library(opentelemetry-cpp::opentelemetry_exporter_zipkin_trace SHARED IMPORTED)

set_target_properties(opentelemetry-cpp::opentelemetry_exporter_zipkin_trace PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "opentelemetry-cpp::trace;opentelemetry-cpp::http_client_curl;nlohmann_json::nlohmann_json"
)
