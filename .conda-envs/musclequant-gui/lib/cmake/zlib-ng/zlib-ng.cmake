...
foreach(_cmake_expected_target IN ITEMS zlib-ng::zlib)
...
# Create imported target zlib-ng::zlib
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/zlib-ng-*.cmake")
