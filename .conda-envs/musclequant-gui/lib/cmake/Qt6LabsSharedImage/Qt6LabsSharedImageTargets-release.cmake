...
set_target_properties(Qt6::LabsSharedImage PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6LabsSharedImage.6.9.2.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libQt6LabsSharedImage.6.dylib"
  )

list(APPEND _cmake_import_check_targets Qt6::LabsSharedImage )
list(APPEND _cmake_import_check_files_for_Qt6::LabsSharedImage "${_IMPORT_PREFIX}/lib/libQt6LabsSharedImage.6.9.2.dylib" )
