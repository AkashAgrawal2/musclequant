...
if (NOT QT_NO_CREATE_TARGETS)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QMacJp2PluginDependencies.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QMacJp2PluginDependencies.cmake")
    else()
        set(QMacJp2Plugin_FOUND TRUE)
    endif()

    if(QMacJp2Plugin_FOUND)
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QMacJp2PluginTargets.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QMacJp2PluginAdditionalTargetInfo.cmake")
    endif()
endif()
