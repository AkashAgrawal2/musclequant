...
if (NOT QT_NO_CREATE_TARGETS)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QMacHeifPluginDependencies.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QMacHeifPluginDependencies.cmake")
    else()
        set(QMacHeifPlugin_FOUND TRUE)
    endif()

    if(QMacHeifPlugin_FOUND)
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QMacHeifPluginTargets.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QMacHeifPluginAdditionalTargetInfo.cmake")
    endif()
endif()
