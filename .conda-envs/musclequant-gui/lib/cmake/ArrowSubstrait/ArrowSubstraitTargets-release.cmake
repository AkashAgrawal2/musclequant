...
set_target_properties(ArrowSubstrait::arrow_substrait_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libarrow_substrait.1500.2.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libarrow_substrait.1500.dylib"
  )

list(APPEND _cmake_import_check_targets ArrowSubstrait::arrow_substrait_shared )
list(APPEND _cmake_import_check_files_for_ArrowSubstrait::arrow_substrait_shared "${_IMPORT_PREFIX}/lib/libarrow_substrait.1500.2.0.dylib" )
