...
set_target_properties(Arrow::arrow_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libarrow.1500.2.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libarrow.1500.dylib"
  )

list(APPEND _cmake_import_check_targets Arrow::arrow_shared )
list(APPEND _cmake_import_check_files_for_Arrow::arrow_shared "${_IMPORT_PREFIX}/lib/libarrow.1500.2.0.dylib" )
