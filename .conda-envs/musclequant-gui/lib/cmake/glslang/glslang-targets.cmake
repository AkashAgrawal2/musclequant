...
add_library(glslang::glslang SHARED IMPORTED)

set_target_properties(glslang::glslang PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLSLANG_IS_SHARED_LIBRARY=1"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "SPIRV-Tools-opt;Threads::Threads"
)

# Create imported target glslang::glslang-default-resource-limits
add_library(glslang::glslang-default-resource-limits SHARED IMPORTED)
