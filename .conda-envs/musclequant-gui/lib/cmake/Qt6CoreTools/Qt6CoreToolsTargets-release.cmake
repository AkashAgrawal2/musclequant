...
set_target_properties(Qt6::syncqt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/syncqt"
  )

list(APPEND _cmake_import_check_targets Qt6::syncqt )
list(APPEND _cmake_import_check_files_for_Qt6::syncqt "${_IMPORT_PREFIX}/lib/qt6/syncqt" )
...
set_target_properties(Qt6::moc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/moc"
  )

list(APPEND _cmake_import_check_targets Qt6::moc )
list(APPEND _cmake_import_check_files_for_Qt6::moc "${_IMPORT_PREFIX}/lib/qt6/moc" )
...
set_target_properties(Qt6::rcc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/rcc"
  )

list(APPEND _cmake_import_check_targets Qt6::rcc )
list(APPEND _cmake_import_check_files_for_Qt6::rcc "${_IMPORT_PREFIX}/lib/qt6/rcc" )
...
set_target_properties(Qt6::tracepointgen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/tracepointgen"
  )

list(APPEND _cmake_import_check_targets Qt6::tracepointgen )
list(APPEND _cmake_import_check_files_for_Qt6::tracepointgen "${_IMPORT_PREFIX}/lib/qt6/tracepointgen" )
...
set_target_properties(Qt6::tracegen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/tracegen"
  )

list(APPEND _cmake_import_check_targets Qt6::tracegen )
list(APPEND _cmake_import_check_files_for_Qt6::tracegen "${_IMPORT_PREFIX}/lib/qt6/tracegen" )
...
set_target_properties(Qt6::cmake_automoc_parser PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/cmake_automoc_parser"
  )

list(APPEND _cmake_import_check_targets Qt6::cmake_automoc_parser )
list(APPEND _cmake_import_check_files_for_Qt6::cmake_automoc_parser "${_IMPORT_PREFIX}/lib/qt6/cmake_automoc_parser" )
...
set_target_properties(Qt6::qlalr PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/qlalr"
  )

list(APPEND _cmake_import_check_targets Qt6::qlalr )
list(APPEND _cmake_import_check_files_for_Qt6::qlalr "${_IMPORT_PREFIX}/lib/qt6/qlalr" )
...
set_target_properties(Qt6::qtpaths PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/bin/qtpaths"
  )

list(APPEND _cmake_import_check_targets Qt6::qtpaths )
list(APPEND _cmake_import_check_files_for_Qt6::qtpaths "${_IMPORT_PREFIX}/lib/qt6/bin/qtpaths" )
...
set_target_properties(Qt6::macdeployqt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/bin/macdeployqt"
  )

list(APPEND _cmake_import_check_targets Qt6::macdeployqt )
list(APPEND _cmake_import_check_files_for_Qt6::macdeployqt "${_IMPORT_PREFIX}/lib/qt6/bin/macdeployqt" )
...
set_target_properties(Qt6::qmake PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/qt6/bin/qmake"
  )

list(APPEND _cmake_import_check_targets Qt6::qmake )
list(APPEND _cmake_import_check_files_for_Qt6::qmake "${_IMPORT_PREFIX}/lib/qt6/bin/qmake" )
