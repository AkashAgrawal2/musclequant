...
if(NOT QT_NO_CREATE_TARGETS AND Qt6CoreTools_FOUND)
    __qt_internal_promote_target_to_global(Qt6::macdeployqt)
endif()

if(NOT QT_NO_CREATE_TARGETS AND Qt6CoreTools_FOUND)
    __qt_internal_promote_target_to_global(Qt6::qmake)
endif()
set(Qt6CoreTools_TARGETS "Qt6::syncqt;Qt6::moc;Qt6::rcc;Qt6::tracepointgen;Qt6::tracegen;Qt6::cmake_automoc_parser;Qt6::qlalr;Qt6::qtpaths;Qt6::macdeployqt;Qt6::qmake")
