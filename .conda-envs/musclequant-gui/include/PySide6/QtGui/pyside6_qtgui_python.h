...
enum [[deprecated]] : int {
    ...
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 970,
    ...
    SBK_QRHIDEPTHSTENCILCLEARVALUE_IDX                       = 592,
    SBK_QRHIDRIVERINFO_DEVICETYPE_IDX                        = 596,
    SBK_QRHIDRIVERINFO_IDX                                   = 594,
    SBK_QRHIGLES2INITPARAMS_IDX                              = 598,
    SBK_QRHIGLES2NATIVEHANDLES_IDX                           = 600,
    SBK_QRHIGRAPHICSPIPELINE_FLAG_IDX                        = 614,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_FLAG_IDX                 = 200,
    SBK_QRHIGRAPHICSPIPELINE_TOPOLOGY_IDX                    = 626,
    SBK_QRHIGRAPHICSPIPELINE_CULLMODE_IDX                    = 612,
    SBK_QRHIGRAPHICSPIPELINE_FRONTFACE_IDX                   = 616,
    SBK_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX          = 608,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX   = 198,
    SBK_QRHIGRAPHICSPIPELINE_BLENDFACTOR_IDX                 = 604,
    SBK_QRHIGRAPHICSPIPELINE_BLENDOP_IDX                     = 606,
    SBK_QRHIGRAPHICSPIPELINE_COMPAREOP_IDX                   = 610,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOP_IDX                   = 620,
    SBK_QRHIGRAPHICSPIPELINE_POLYGONMODE_IDX                 = 618,
    SBK_QRHIGRAPHICSPIPELINE_IDX                             = 602,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOPSTATE_IDX              = 622,
    SBK_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX                 = 624,
    SBK_QRHIINITPARAMS_IDX                                   = 628,
    SBK_QRHIMETALINITPARAMS_IDX                              = 630,
    SBK_QRHINATIVEHANDLES_IDX                                = 632,
    SBK_QRHINULLINITPARAMS_IDX                               = 634,
    SBK_QRHIREADBACKDESCRIPTION_IDX                          = 636,
    SBK_QRHIREADBACKRESULT_IDX                               = 638,
    SBK_QRHIRENDERBUFFER_TYPE_IDX                            = 644,
    SBK_QRHIRENDERBUFFER_FLAG_IDX                            = 642,
    SBK_QFLAGS_QRHIRENDERBUFFER_FLAG_IDX                     = 202,
    SBK_QRHIRENDERBUFFER_IDX                                 = 640,
    SBK_QRHIRENDERPASSDESCRIPTOR_IDX                         = 646,
    SBK_QRHIRENDERTARGET_IDX                                 = 648,
    SBK_QRHIRESOURCE_TYPE_IDX                                = 652,
    SBK_QRHIRESOURCE_IDX                                     = 650,
    SBK_QRHIRESOURCEUPDATEBATCH_IDX                          = 654,
    SBK_QRHISAMPLER_FILTER_IDX                               = 662,
    SBK_QRHISAMPLER_ADDRESSMODE_IDX                          = 658,
    SBK_QRHISAMPLER_COMPAREOP_IDX                            = 660,
    SBK_QRHISAMPLER_IDX                                      = 656,
    SBK_QRHISCISSOR_IDX                                      = 664,
    SBK_QRHISHADERRESOURCEBINDING_TYPE_IDX                   = 678,
    SBK_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX              = 674,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX       = 204,
    SBK_QRHISHADERRESOURCEBINDING_IDX                        = 666,
    SBK_QRHISHADERRESOURCEBINDING_DATA_IDX                   = 668,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEBUFFERDATA_IDX = 670,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEIMAGEDATA_IDX  = 672,
    SBK_QRHISHADERRESOURCEBINDING_TEXTUREANDSAMPLER_IDX      = 676,
    SBK_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX            = 682,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX     = 206,
    SBK_QRHISHADERRESOURCEBINDINGS_IDX                       = 680,
    SBK_QRHISHADERSTAGE_TYPE_IDX                             = 686,
    SBK_QRHISHADERSTAGE_IDX                                  = 684,
    SBK_QRHISTATS_IDX                                        = 688,
    SBK_QRHISWAPCHAIN_FLAG_IDX                               = 692,
    SBK_QFLAGS_QRHISWAPCHAIN_FLAG_IDX                        = 208,
    SBK_QRHISWAPCHAIN_FORMAT_IDX                             = 694,
    SBK_QRHISWAPCHAIN_STEREOTARGETBUFFER_IDX                 = 696,
    SBK_QRHISWAPCHAIN_IDX                                    = 690,
    SBK_QRHISWAPCHAINRENDERTARGET_IDX                        = 698,
    SBK_QRHITEXTURE_FLAG_IDX                                 = 702,
    SBK_QFLAGS_QRHITEXTURE_FLAG_IDX                          = 210,
    SBK_QRHITEXTURE_FORMAT_IDX                               = 704,
    SBK_QRHITEXTURE_IDX                                      = 700,
    SBK_QRHITEXTURE_VIEWFORMAT_IDX                           = 706,
    SBK_QRHITEXTURECOPYDESCRIPTION_IDX                       = 708,
    SBK_QRHITEXTURERENDERTARGET_FLAG_IDX                     = 712,
    SBK_QFLAGS_QRHITEXTURERENDERTARGET_FLAG_IDX              = 212,
    SBK_QRHITEXTURERENDERTARGET_IDX                          = 710,
    SBK_QRHITEXTURERENDERTARGETDESCRIPTION_IDX               = 714,
    SBK_QRHITEXTURESUBRESOURCEUPLOADDESCRIPTION_IDX          = 716,
    SBK_QRHITEXTUREUPLOADDESCRIPTION_IDX                     = 718,
    SBK_QRHITEXTUREUPLOADENTRY_IDX                           = 720,
    SBK_QRHIVERTEXINPUTATTRIBUTE_FORMAT_IDX                  = 724,
    SBK_QRHIVERTEXINPUTATTRIBUTE_IDX                         = 722,
    SBK_QRHIVERTEXINPUTBINDING_CLASSIFICATION_IDX            = 728,
    SBK_QRHIVERTEXINPUTBINDING_IDX                           = 726,
    SBK_QRHIVERTEXINPUTLAYOUT_IDX                            = 730,
    SBK_QRHIVIEWPORT_IDX                                     = 732,
    SBK_QSCREEN_IDX                                          = 734,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 738,
    SBK_QSCROLLEVENT_IDX                                     = 736,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 740,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 744,
    SBK_QSESSIONMANAGER_IDX                                  = 742,
    SBK_QSHADER_STAGE_IDX                                    = 752,
    SBK_QSHADER_SOURCE_IDX                                   = 750,
    SBK_QSHADER_VARIANT_IDX                                  = 754,
    SBK_QSHADER_SERIALIZEDFORMATVERSION_IDX                  = 748,
    SBK_QSHADER_IDX                                          = 746,
    SBK_QSHADERCODE_IDX                                      = 756,
    SBK_QSHADERKEY_IDX                                       = 758,
    SBK_QSHADERVERSION_FLAG_IDX                              = 762,
    SBK_QFLAGS_QSHADERVERSION_FLAG_IDX                       = 214,
    SBK_QSHADERVERSION_IDX                                   = 760,
    SBK_QSHORTCUT_IDX                                        = 764,
    SBK_QSHORTCUTEVENT_IDX                                   = 766,
    SBK_QSHOWEVENT_IDX                                       = 768,
    SBK_QSINGLEPOINTEVENT_IDX                                = 770,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 774,
    SBK_QSTANDARDITEM_IDX                                    = 772,
    SBK_QSTANDARDITEMMODEL_IDX                               = 776,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 780,
    SBK_QSTATICTEXT_IDX                                      = 778,
    SBK_QSTATUSTIPEVENT_IDX                                  = 782,
    SBK_QSTYLEHINTS_IDX                                      = 784,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 788,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 790,
    SBK_QSURFACE_IDX                                         = 786,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 796,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 216,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 802,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 800,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 798,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 794,
    SBK_QSURFACEFORMAT_IDX                                   = 792,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 804,
    SBK_QTABLETEVENT_IDX                                     = 806,
    SBK_QTEXTBLOCK_IDX                                       = 808,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 810,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 972,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 814,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 812,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 816,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 818,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 826,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 824,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 822,
    SBK_QTEXTCHARFORMAT_IDX                                  = 820,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 830,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 832,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 834,
    SBK_QTEXTCURSOR_IDX                                      = 828,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 842,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 840,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 220,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 838,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 218,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 844,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 846,
    SBK_QTEXTDOCUMENT_IDX                                    = 836,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 848,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 850,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 854,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 860,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 856,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 858,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 222,
    SBK_QTEXTFORMAT_IDX                                      = 852,
    SBK_QTEXTFRAGMENT_IDX                                    = 862,
    SBK_QTEXTFRAME_IDX                                       = 864,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 866,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 872,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 870,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 868,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 874,
    SBK_QTEXTINLINEOBJECT_IDX                                = 876,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 880,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 224,
    SBK_QTEXTITEM_IDX                                        = 878,
    SBK_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX                = 888,
    SBK_QFLAGS_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX         = 226,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 884,
    SBK_QTEXTLAYOUT_IDX                                      = 882,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 886,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 892,
    SBK_QTEXTLENGTH_IDX                                      = 890,
    SBK_QTEXTLINE_EDGE_IDX                                   = 898,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 896,
    SBK_QTEXTLINE_IDX                                        = 894,
    SBK_QTEXTLIST_IDX                                        = 900,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 904,
    SBK_QTEXTLISTFORMAT_IDX                                  = 902,
    SBK_QTEXTOBJECT_IDX                                      = 906,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 908,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 916,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 918,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 912,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 228,
    SBK_QTEXTOPTION_IDX                                      = 910,
    SBK_QTEXTOPTION_TAB_IDX                                  = 914,
    SBK_QTEXTTABLE_IDX                                       = 920,
    SBK_QTEXTTABLECELL_IDX                                   = 922,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 924,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 926,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 928,
    SBK_QTOUCHEVENT_IDX                                      = 930,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 934,
    SBK_QTRANSFORM_IDX                                       = 932,
    SBK_QUNDOCOMMAND_IDX                                     = 936,
    SBK_QUNDOGROUP_IDX                                       = 938,
    SBK_QUNDOSTACK_IDX                                       = 940,
    SBK_QVALIDATOR_STATE_IDX                                 = 944,
    SBK_QVALIDATOR_IDX                                       = 942,
    SBK_QVECTOR2D_IDX                                        = 946,
    SBK_QVECTOR3D_IDX                                        = 948,
    SBK_QVECTOR4D_IDX                                        = 950,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 952,
    SBK_QWHEELEVENT_IDX                                      = 954,
    SBK_QWINDOW_VISIBILITY_IDX                               = 960,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 958,
    SBK_QWINDOW_IDX                                          = 956,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 962,
    SBK_QTGUIQT_IDX                                          = 964,
    SBK_QTGUIHELPER_QOVERRIDECURSORGUARD_IDX                 = 968,
    SBK_QTGUI_IDX_COUNT                                      = 974,
};
...
enum : int {
    ...
    SBK_QFont_HintingPreference_IDX                          = 485,
    ...
    SBK_QRhiDepthStencilClearValue_IDX                       = 296,
    SBK_QRhiDriverInfo_DeviceType_IDX                        = 298,
    SBK_QRhiDriverInfo_IDX                                   = 297,
    SBK_QRhiGles2InitParams_IDX                              = 299,
    SBK_QRhiGles2NativeHandles_IDX                           = 300,
    SBK_QRhiGraphicsPipeline_Flag_IDX                        = 307,
    SBK_QFlags_QRhiGraphicsPipeline_Flag_IDX                 = 100,
    SBK_QRhiGraphicsPipeline_Topology_IDX                    = 313,
    SBK_QRhiGraphicsPipeline_CullMode_IDX                    = 306,
    SBK_QRhiGraphicsPipeline_FrontFace_IDX                   = 308,
    SBK_QRhiGraphicsPipeline_ColorMaskComponent_IDX          = 304,
    SBK_QFlags_QRhiGraphicsPipeline_ColorMaskComponent_IDX   = 99,
    SBK_QRhiGraphicsPipeline_BlendFactor_IDX                 = 302,
    SBK_QRhiGraphicsPipeline_BlendOp_IDX                     = 303,
    SBK_QRhiGraphicsPipeline_CompareOp_IDX                   = 305,
    SBK_QRhiGraphicsPipeline_StencilOp_IDX                   = 310,
    SBK_QRhiGraphicsPipeline_PolygonMode_IDX                 = 309,
    SBK_QRhiGraphicsPipeline_IDX                             = 301,
    SBK_QRhiGraphicsPipeline_StencilOpState_IDX              = 311,
    SBK_QRhiGraphicsPipeline_TargetBlend_IDX                 = 312,
    SBK_QRhiInitParams_IDX                                   = 314,
    SBK_QRhiMetalInitParams_IDX                              = 315,
    SBK_QRhiNativeHandles_IDX                                = 316,
    SBK_QRhiNullInitParams_IDX                               = 317,
    SBK_QRhiReadbackDescription_IDX                          = 318,
    SBK_QRhiReadbackResult_IDX                               = 319,
    SBK_QRhiRenderBuffer_Type_IDX                            = 322,
    SBK_QRhiRenderBuffer_Flag_IDX                            = 321,
    SBK_QFlags_QRhiRenderBuffer_Flag_IDX                     = 101,
    SBK_QRhiRenderBuffer_IDX                                 = 320,
    SBK_QRhiRenderPassDescriptor_IDX                         = 323,
    SBK_QRhiRenderTarget_IDX                                 = 324,
    SBK_QRhiResource_Type_IDX                                = 326,
    SBK_QRhiResource_IDX                                     = 325,
    SBK_QRhiResourceUpdateBatch_IDX                          = 327,
    SBK_QRhiSampler_Filter_IDX                               = 331,
    SBK_QRhiSampler_AddressMode_IDX                          = 329,
    SBK_QRhiSampler_CompareOp_IDX                            = 330,
    SBK_QRhiSampler_IDX                                      = 328,
    SBK_QRhiScissor_IDX                                      = 332,
    SBK_QRhiShaderResourceBinding_Type_IDX                   = 339,
    SBK_QRhiShaderResourceBinding_StageFlag_IDX              = 337,
    SBK_QFlags_QRhiShaderResourceBinding_StageFlag_IDX       = 102,
    SBK_QRhiShaderResourceBinding_IDX                        = 333,
    SBK_QRhiShaderResourceBinding_Data_IDX                   = 334,
    SBK_QRhiShaderResourceBinding_Data_StorageBufferData_IDX = 335,
    SBK_QRhiShaderResourceBinding_Data_StorageImageData_IDX  = 336,
    SBK_QRhiShaderResourceBinding_TextureAndSampler_IDX      = 338,
    SBK_QRhiShaderResourceBindings_UpdateFlag_IDX            = 341,
    SBK_QFlags_QRhiShaderResourceBindings_UpdateFlag_IDX     = 103,
    SBK_QRhiShaderResourceBindings_IDX                       = 340,
    SBK_QRhiShaderStage_Type_IDX                             = 343,
    SBK_QRhiShaderStage_IDX                                  = 342,
    SBK_QRhiStats_IDX                                        = 344,
    SBK_QRhiSwapChain_Flag_IDX                               = 346,
    SBK_QFlags_QRhiSwapChain_Flag_IDX                        = 104,
    SBK_QRhiSwapChain_Format_IDX                             = 347,
    SBK_QRhiSwapChain_StereoTargetBuffer_IDX                 = 348,
    SBK_QRhiSwapChain_IDX                                    = 345,
    SBK_QRhiSwapChainRenderTarget_IDX                        = 349,
    SBK_QRhiTexture_Flag_IDX                                 = 351,
    SBK_QFlags_QRhiTexture_Flag_IDX                          = 105,
    SBK_QRhiTexture_Format_IDX                               = 352,
    SBK_QRhiTexture_IDX                                      = 350,
    SBK_QRhiTexture_ViewFormat_IDX                           = 353,
    SBK_QRhiTextureCopyDescription_IDX                       = 354,
    SBK_QRhiTextureRenderTarget_Flag_IDX                     = 356,
    SBK_QFlags_QRhiTextureRenderTarget_Flag_IDX              = 106,
    SBK_QRhiTextureRenderTarget_IDX                          = 355,
    SBK_QRhiTextureRenderTargetDescription_IDX               = 357,
    SBK_QRhiTextureSubresourceUploadDescription_IDX          = 358,
    SBK_QRhiTextureUploadDescription_IDX                     = 359,
    SBK_QRhiTextureUploadEntry_IDX                           = 360,
    SBK_QRhiVertexInputAttribute_Format_IDX                  = 362,
    SBK_QRhiVertexInputAttribute_IDX                         = 361,
    SBK_QRhiVertexInputBinding_Classification_IDX            = 364,
    SBK_QRhiVertexInputBinding_IDX                           = 363,
    SBK_QRhiVertexInputLayout_IDX                            = 365,
    SBK_QRhiViewport_IDX                                     = 366,
    SBK_QScreen_IDX                                          = 367,
    SBK_QScrollEvent_ScrollState_IDX                         = 369,
    SBK_QScrollEvent_IDX                                     = 368,
    SBK_QScrollPrepareEvent_IDX                              = 370,
    SBK_QSessionManager_RestartHint_IDX                      = 372,
    SBK_QSessionManager_IDX                                  = 371,
    SBK_QShader_Stage_IDX                                    = 376,
    SBK_QShader_Source_IDX                                   = 375,
    SBK_QShader_Variant_IDX                                  = 377,
    SBK_QShader_SerializedFormatVersion_IDX                  = 374,
    SBK_QShader_IDX                                          = 373,
    SBK_QShaderCode_IDX                                      = 378,
    SBK_QShaderKey_IDX                                       = 379,
    SBK_QShaderVersion_Flag_IDX                              = 381,
    SBK_QFlags_QShaderVersion_Flag_IDX                       = 107,
    SBK_QShaderVersion_IDX                                   = 380,
    SBK_QShortcut_IDX                                        = 382,
    SBK_QShortcutEvent_IDX                                   = 383,
    SBK_QShowEvent_IDX                                       = 384,
    SBK_QSinglePointEvent_IDX                                = 385,
    SBK_QStandardItem_ItemType_IDX                           = 387,
    SBK_QStandardItem_IDX                                    = 386,
    SBK_QStandardItemModel_IDX                               = 388,
    SBK_QStaticText_PerformanceHint_IDX                      = 390,
    SBK_QStaticText_IDX                                      = 389,
    SBK_QStatusTipEvent_IDX                                  = 391,
    SBK_QStyleHints_IDX                                      = 392,
    SBK_QSurface_SurfaceClass_IDX                            = 394,
    SBK_QSurface_SurfaceType_IDX                             = 395,
    SBK_QSurface_IDX                                         = 393,
    SBK_QSurfaceFormat_FormatOption_IDX                      = 398,
    SBK_QFlags_QSurfaceFormat_FormatOption_IDX               = 108,
    SBK_QSurfaceFormat_SwapBehavior_IDX                      = 401,
    SBK_QSurfaceFormat_RenderableType_IDX                    = 400,
    SBK_QSurfaceFormat_OpenGLContextProfile_IDX              = 399,
    SBK_QSurfaceFormat_ColorSpace_IDX                        = 397,
    SBK_QSurfaceFormat_IDX                                   = 396,
    SBK_QSyntaxHighlighter_IDX                               = 402,
    SBK_QTabletEvent_IDX                                     = 403,
    SBK_QTextBlock_IDX                                       = 404,
    SBK_QTextBlock_iterator_IDX                              = 405,
    SBK_QTextBlockFormat_LineHeightTypes_IDX                 = 486,
    SBK_QTextBlockFormat_MarkerType_IDX                      = 407,
    SBK_QTextBlockFormat_IDX                                 = 406,
    SBK_QTextBlockGroup_IDX                                  = 408,
    SBK_QTextBlockUserData_IDX                               = 409,
    SBK_QTextCharFormat_VerticalAlignment_IDX                = 413,
    SBK_QTextCharFormat_UnderlineStyle_IDX                   = 412,
    SBK_QTextCharFormat_FontPropertiesInheritanceBehavior_IDX = 411,
    SBK_QTextCharFormat_IDX                                  = 410,
    SBK_QTextCursor_MoveMode_IDX                             = 415,
    SBK_QTextCursor_MoveOperation_IDX                        = 416,
    SBK_QTextCursor_SelectionType_IDX                        = 417,
    SBK_QTextCursor_IDX                                      = 414,
    SBK_QTextDocument_MetaInformation_IDX                    = 421,
    SBK_QTextDocument_MarkdownFeature_IDX                    = 420,
    SBK_QFlags_QTextDocument_MarkdownFeature_IDX             = 110,
    SBK_QTextDocument_FindFlag_IDX                           = 419,
    SBK_QFlags_QTextDocument_FindFlag_IDX                    = 109,
    SBK_QTextDocument_ResourceType_IDX                       = 422,
    SBK_QTextDocument_Stacks_IDX                             = 423,
    SBK_QTextDocument_IDX                                    = 418,
    SBK_QTextDocumentFragment_IDX                            = 424,
    SBK_QTextDocumentWriter_IDX                              = 425,
    SBK_QTextFormat_FormatType_IDX                           = 427,
    SBK_QTextFormat_Property_IDX                             = 430,
    SBK_QTextFormat_ObjectTypes_IDX                          = 428,
    SBK_QTextFormat_PageBreakFlag_IDX                        = 429,
    SBK_QFlags_QTextFormat_PageBreakFlag_IDX                 = 111,
    SBK_QTextFormat_IDX                                      = 426,
    SBK_QTextFragment_IDX                                    = 431,
    SBK_QTextFrame_IDX                                       = 432,
    SBK_QTextFrame_iterator_IDX                              = 433,
    SBK_QTextFrameFormat_Position_IDX                        = 436,
    SBK_QTextFrameFormat_BorderStyle_IDX                     = 435,
    SBK_QTextFrameFormat_IDX                                 = 434,
    SBK_QTextImageFormat_IDX                                 = 437,
    SBK_QTextInlineObject_IDX                                = 438,
    SBK_QTextItem_RenderFlag_IDX                             = 440,
    SBK_QFlags_QTextItem_RenderFlag_IDX                      = 112,
    SBK_QTextItem_IDX                                        = 439,
    SBK_QTextLayout_GlyphRunRetrievalFlag_IDX                = 444,
    SBK_QFlags_QTextLayout_GlyphRunRetrievalFlag_IDX         = 113,
    SBK_QTextLayout_CursorMode_IDX                           = 442,
    SBK_QTextLayout_IDX                                      = 441,
    SBK_QTextLayout_FormatRange_IDX                          = 443,
    SBK_QTextLength_Type_IDX                                 = 446,
    SBK_QTextLength_IDX                                      = 445,
    SBK_QTextLine_Edge_IDX                                   = 449,
    SBK_QTextLine_CursorPosition_IDX                         = 448,
    SBK_QTextLine_IDX                                        = 447,
    SBK_QTextList_IDX                                        = 450,
    SBK_QTextListFormat_Style_IDX                            = 452,
    SBK_QTextListFormat_IDX                                  = 451,
    SBK_QTextObject_IDX                                      = 453,
    SBK_QTextObjectInterface_IDX                             = 454,
    SBK_QTextOption_TabType_IDX                              = 458,
    SBK_QTextOption_WrapMode_IDX                             = 459,
    SBK_QTextOption_Flag_IDX                                 = 456,
    SBK_QFlags_QTextOption_Flag_IDX                          = 114,
    SBK_QTextOption_IDX                                      = 455,
    SBK_QTextOption_Tab_IDX                                  = 457,
    SBK_QTextTable_IDX                                       = 460,
    SBK_QTextTableCell_IDX                                   = 461,
    SBK_QTextTableCellFormat_IDX                             = 462,
    SBK_QTextTableFormat_IDX                                 = 463,
    SBK_QToolBarChangeEvent_IDX                              = 464,
    SBK_QTouchEvent_IDX                                      = 465,
    SBK_QTransform_TransformationType_IDX                    = 467,
    SBK_QTransform_IDX                                       = 466,
    SBK_QUndoCommand_IDX                                     = 468,
    SBK_QUndoGroup_IDX                                       = 469,
    SBK_QUndoStack_IDX                                       = 470,
    SBK_QValidator_State_IDX                                 = 472,
    SBK_QValidator_IDX                                       = 471,
    SBK_QVector2D_IDX                                        = 473,
    SBK_QVector3D_IDX                                        = 474,
    SBK_QVector4D_IDX                                        = 475,
    SBK_QWhatsThisClickedEvent_IDX                           = 476,
    SBK_QWheelEvent_IDX                                      = 477,
    SBK_QWindow_Visibility_IDX                               = 480,
    SBK_QWindow_AncestorMode_IDX                             = 479,
    SBK_QWindow_IDX                                          = 478,
    SBK_QWindowStateChangeEvent_IDX                          = 481,
    SBK_QtGuiQt_IDX                                          = 482,
    SBK_QtGuiHelper_QOverrideCursorGuard_IDX                 = 484,
    SBK_QtGui_IDX_COUNT                                      = 487,
};
...
enum [[deprecated]] : int {
    ...
    SBK_QTGUI_QLIST_QSIZE_IDX                                = 42, // QList<QSize>
    SBK_QTGUI_QLIST_QPOINTF_IDX                              = 44, // QList<QPointF>
    SBK_QTGUI_QLIST_QUINT32_IDX                              = 46, // QList<quint32>
    SBK_QTGUI_QLIST_QFONTDATABASE_WRITINGSYSTEM_IDX          = 48, // QList<QFontDatabase::WritingSystem>
    SBK_QTGUI_QLIST_QPOINT_IDX                               = 50, // QList<QPoint>
    SBK_QTGUI_QLIST_QPOLYGONF_IDX                            = 52, // QList<QPolygonF>
    SBK_QTGUI_QLIST_QPAGERANGES_RANGE_IDX                    = 54, // QList<QPageRanges::Range>
    SBK_QTGUI_QLIST_FLOAT_IDX                                = 56, // QList<float>
    ...
    SBK_QTGUI_QLIST_QFONTVARIABLEAXIS_IDX                    = 64, // QList<QFontVariableAxis>
    SBK_QTGUI_QLIST_QFONT_TAG_IDX                            = 66, // QList<QFont::Tag>
    SBK_QTGUI_QLIST_UINT16_T_IDX                             = 68, // QList<uint16_t>
    SBK_QTGUI_QLIST_QACCESSIBLEINTERFACEPTR_IDX              = 70, // QList<QAccessibleInterface*>
    SBK_QTGUI_STD_PAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 72, // std::pair<QAccessibleInterface*,QFlags<QAccessible::RelationFlag>>
    SBK_QTGUI_QLIST_STD_PAIR_QACCESSIBLEINTERFACEPTR_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX = 74, // QList<std::pair<QAccessibleInterface*,QFlags<QAccessible::RelationFlag>>>
    SBK_QTGUI_QLIST_QACCESSIBLE_ATTRIBUTE_IDX                = 76, // QList<QAccessible::Attribute>
    SBK_QTGUI_QLIST_UNSIGNEDINT_IDX                          = 78, // QList<unsigned int>
    SBK_QTGUI_QLIST_QLINE_IDX                                = 80, // QList<QLine>
    SBK_QTGUI_QLIST_QLINEF_IDX                               = 82, // QList<QLineF>
    SBK_QTGUI_QLIST_QRECT_IDX                                = 84, // QList<QRect>
    SBK_QTGUI_QLIST_QRECTF_IDX                               = 86, // QList<QRectF>
    SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                         = 88, // QList<QKeySequence>
    ...
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 108, // QList<QObject*>
    SBK_QTGUI_QLIST_QABSTRACTTEXTDOCUMENTLAYOUT_SELECTION_IDX = 110, // QList<QAbstractTextDocumentLayout::Selection>
    SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX          = 112, // QList<QInputMethodEvent::Attribute>
    SBK_QTGUI_QLIST_QEVENTPOINT_IDX                          = 114, // QList<QEventPoint>
    SBK_QTGUI_QLIST_QWINDOWPTR_IDX                           = 116, // QList<QWindow*>
    SBK_QTGUI_QLIST_QBYTEARRAY_IDX                           = 118, // QList<QByteArray>
    SBK_QTGUI_QLIST_QRHISHADERRESOURCEBINDING_IDX            = 120, // QList<QRhiShaderResourceBinding>
    SBK_QTGUI_QLIST_QRHISHADERSTAGE_IDX                      = 122, // QList<QRhiShaderStage>
    SBK_QTGUI_QLIST_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX     = 124, // QList<QRhiGraphicsPipeline::TargetBlend>
    SBK_QTGUI_STD_PAIR_INT_UNSIGNEDINT_IDX                   = 126, // std::pair<int,unsigned int>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX             = 128, // std::pair<QRhiBuffer*,quint32>
    SBK_QTGUI_QLIST_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX       = 130, // QList<std::pair<QRhiBuffer*,quint32>>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_UNSIGNEDINT_IDX         = 132, // std::pair<QRhiBuffer*,unsigned int>
    SBK_QTGUI_QLIST_QMODELINDEX_IDX                          = 134, // QList<QModelIndex>
    SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                       = 136, // QHash<int,QByteArray>
    SBK_QTGUI_QLIST_QVARIANT_IDX                             = 138, // QList<QVariant>
    SBK_QTGUI_QLIST_QSTRING_IDX                              = 140, // QList<QString>
    SBK_QTGUI_QMAP_QSTRING_QVARIANT_IDX                      = 142, // QMap<QString,QVariant>
    SBK_QTGUI_CONVERTERS_IDX_COUNT                           = 144,
};
...
enum : int {
    ...
    SBK_QtGui_QList_QSize_IDX                                = 21, // QList<QSize>
    SBK_QtGui_QList_QPointF_IDX                              = 22, // QList<QPointF>
    SBK_QtGui_QList_quint32_IDX                              = 23, // QList<quint32>
    SBK_QtGui_QList_QFontDatabase_WritingSystem_IDX          = 24, // QList<QFontDatabase::WritingSystem>
    SBK_QtGui_QList_QPoint_IDX                               = 25, // QList<QPoint>
    SBK_QtGui_QList_QPolygonF_IDX                            = 26, // QList<QPolygonF>
    SBK_QtGui_QList_QPageRanges_Range_IDX                    = 27, // QList<QPageRanges::Range>
    SBK_QtGui_QList_float_IDX                                = 28, // QList<float>
    ...
    SBK_QtGui_QList_QFontVariableAxis_IDX                    = 32, // QList<QFontVariableAxis>
    SBK_QtGui_QList_QFont_Tag_IDX                            = 33, // QList<QFont::Tag>
    SBK_QtGui_QList_uint16_t_IDX                             = 34, // QList<uint16_t>
    SBK_QtGui_QList_QAccessibleInterfacePTR_IDX              = 35, // QList<QAccessibleInterface*>
    SBK_QtGui_std_pair_QAccessibleInterfacePTR_QFlags_QAccessible_RelationFlag_IDX = 36, // std::pair<QAccessibleInterface*,QFlags<QAccessible::RelationFlag>>
    SBK_QtGui_QList_std_pair_QAccessibleInterfacePTR_QFlags_QAccessible_RelationFlag_IDX = 37, // QList<std::pair<QAccessibleInterface*,QFlags<QAccessible::RelationFlag>>>
    SBK_QtGui_QList_QAccessible_Attribute_IDX                = 38, // QList<QAccessible::Attribute>
    ...
    SBK_QtGui_QList_QObjectPTR_IDX                           = 54, // QList<QObject*>
    SBK_QtGui_QList_QAbstractTextDocumentLayout_Selection_IDX = 55, // QList<QAbstractTextDocumentLayout::Selection>
    SBK_QtGui_QList_QInputMethodEvent_Attribute_IDX          = 56, // QList<QInputMethodEvent::Attribute>
    SBK_QtGui_QList_QEventPoint_IDX                          = 57, // QList<QEventPoint>
    SBK_QtGui_QList_QWindowPTR_IDX                           = 58, // QList<QWindow*>
    SBK_QtGui_QList_QByteArray_IDX                           = 59, // QList<QByteArray>
