...
class ExportMetricsPartialSuccess final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.metrics.v1.ExportMetricsPartialSuccess) */ {
 public:
  ...
  inline ExportMetricsPartialSuccess(const ExportMetricsPartialSuccess& from)
      : ExportMetricsPartialSuccess(nullptr, from) {}
...
class ExportMetricsServiceResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceResponse) */ {
 public:
  ...
  inline ExportMetricsServiceResponse(const ExportMetricsServiceResponse& from)
      : ExportMetricsServiceResponse(nullptr, from) {}
...
class ExportMetricsServiceRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceRequest) */ {
 public:
  ...
  inline ExportMetricsServiceRequest(const ExportMetricsServiceRequest& from)
      : ExportMetricsServiceRequest(nullptr, from) {}
...
inline void ExportMetricsServiceResponse::set_allocated_partial_success(::opentelemetry::proto::collector::metrics::v1::ExportMetricsPartialSuccess* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::opentelemetry::proto::collector::metrics::v1::ExportMetricsPartialSuccess*>(_impl_.partial_success_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::opentelemetry::proto::collector::metrics::v1::ExportMetricsPartialSuccess*>(value)->GetArena();
