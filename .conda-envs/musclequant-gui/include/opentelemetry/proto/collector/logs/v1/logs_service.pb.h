...
class ExportLogsPartialSuccess final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.logs.v1.ExportLogsPartialSuccess) */ {
 public:
  ...
  inline ExportLogsPartialSuccess(const ExportLogsPartialSuccess& from)
      : ExportLogsPartialSuccess(nullptr, from) {}
...
class ExportLogsServiceResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse) */ {
 public:
  ...
  inline ExportLogsServiceResponse(const ExportLogsServiceResponse& from)
      : ExportLogsServiceResponse(nullptr, from) {}
...
class ExportLogsServiceRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest) */ {
 public:
  ...
  inline ExportLogsServiceRequest(const ExportLogsServiceRequest& from)
      : ExportLogsServiceRequest(nullptr, from) {}
...
inline void ExportLogsServiceResponse::set_allocated_partial_success(::opentelemetry::proto::collector::logs::v1::ExportLogsPartialSuccess* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::opentelemetry::proto::collector::logs::v1::ExportLogsPartialSuccess*>(_impl_.partial_success_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::opentelemetry::proto::collector::logs::v1::ExportLogsPartialSuccess*>(value)->GetArena();
