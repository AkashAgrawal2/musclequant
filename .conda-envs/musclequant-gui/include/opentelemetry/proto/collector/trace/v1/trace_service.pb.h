...
class ExportTracePartialSuccess final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.trace.v1.ExportTracePartialSuccess) */ {
 public:
  inline ExportTracePartialSuccess() : ExportTracePartialSuccess(nullptr) {}
  ~ExportTracePartialSuccess() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ExportTracePartialSuccess(::google::protobuf::internal::ConstantInitialized);

  inline ExportTracePartialSuccess(const ExportTracePartialSuccess& from)
      : ExportTracePartialSuccess(nullptr, from) {}
...
class ExportTraceServiceResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.trace.v1.ExportTraceServiceResponse) */ {
 public:
  inline ExportTraceServiceResponse() : ExportTraceServiceResponse(nullptr) {}
  ~ExportTraceServiceResponse() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ExportTraceServiceResponse(::google::protobuf::internal::ConstantInitialized);

  inline ExportTraceServiceResponse(const ExportTraceServiceResponse& from)
      : ExportTraceServiceResponse(nullptr, from) {}
...
class ExportTraceServiceRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.trace.v1.ExportTraceServiceRequest) */ {
 public:
  inline ExportTraceServiceRequest() : ExportTraceServiceRequest(nullptr) {}
  ~ExportTraceServiceRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ExportTraceServiceRequest(::google::protobuf::internal::ConstantInitialized);

  inline ExportTraceServiceRequest(const ExportTraceServiceRequest& from)
      : ExportTraceServiceRequest(nullptr, from) {}
...
inline void ExportTraceServiceResponse::set_allocated_partial_success(::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess*>(_impl_.partial_success_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess*>(value)->GetArena();
